...
const nouns = ["wife.", "girlfriend.", "long distance low commitment casual gf.", "three-week situationship."];
...
function getQueryParams() {
    ...
    let noun = params.get("noun");
    let adjective = params.get("adjective");
    
    if (!nouns.includes(noun)) {
        noun = "girlfriend."; // Default noun
    }
    if (!adjectives.includes(adjective)) {
        adjective = "kind"; // Default adjective
    }
